 ...
 * @public
 */
export type FilemapLike = Immutable.Map<string, Buffer | string> | { [key: string]: Buffer | string };
 ...
 * @public
 */
export type LooseTransform = (inputFilemap: Filemap) => FilemapLike | Promise<FilemapLike>;
 ...
 * @public
 */
export type PermissiveTransform = (inputFilemap: FilemapLike) => Filemap | Promise<Filemap>;
 ...
 * @public
 */
export type Matchable = RegExp | Array<string> | string | boolean | void | null | (name: string) => any;
...
export type GranularBuildFunction = (content: Buffer, name: string, include: IncludeFunction) => Buffer | { [name: string]: Buffer | string } | null;