...
export default function singleFile<Args: Array<any>, ReturnValue: any>(fn: (...args: Args) => ReturnValue | Promise<ReturnValue>, context: any): (...args: Args) => Promise<ReturnValue> {
